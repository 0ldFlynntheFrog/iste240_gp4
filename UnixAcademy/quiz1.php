...
<fieldset>
            ...
            <input type="radio" id="q3a2" name="question1" value="False">
...
<fieldset>
            ...
            <label for="q2a1">Serves as the home for Unix commands</label><br>

            <input type="radio" id="q3a2" name="question3" value="Helps us navigate our way around our computer">
            <label for="q2a2">Helps us navigate our way around our computer</label><br>

            <input type="radio" id="q3a3" name="question3" value="Serves as communication between the user and computer">
            <label for="q2a3">Serves as communication between the user and computer</label><br>
