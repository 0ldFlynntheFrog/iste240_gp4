...
<main class="chapter-content">
    ...
    <p>
        ...
        Alternatively, you can type 'cd' and press the tab button to cycle through subdirectories within the directory or use the tab button to 
    ...
    <p>
        ...
        to provide an absolute path to properly execute this command into the command prompt.
    </p>
    <p>
